      ...
      <div data-custom-class="body">
        <div align="center" style={{ textAlign: "left" }}>
          <div>
            <strong>
              <span style={{ fontSize: 26 }}>
                <p className="text-yellow-500">TERMS OF USE</p>
              </span>
            </strong>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            <strong>
              <span classname="text-white">AGREEMENT TO OUR LEGAL TERMS</span>
            </strong>
          </div>
        </div>
        <div align="center" style={{ textAlign: "left" }}>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <span style={{ color: "rgb(0, 58, 250)" }}>
                <bdt className="question">
                  <a
                    href="https://www.pokestratbuilder.com"
                    target="_blank"
                    data-custom-class="link"
                  >
                    https://www.pokestratbuilder.com
                  </a>
                </bdt>
              </span>{" "}
          ...
          >
            ...
            >
              ...
              email at <bdt className="question">n.h.ejim@gmail.com</bdt>
            </span>
          </div>
          <div className="MsoNormal" style={{ lineHeight: 1 }}>
            <br />
          ...
          >
            ...
            >
              ...
              <bdt className="statement-end-if-in-editor" />
              ), and <bdt className="question">DaWinnaProductions</bdt>,
          ...
          >
            ...
            >
              ...
              <bdt className="question">pokestrat.teambuilder@gmail.com</bdt>,
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <bdt className="question">n.h.ejim@gmail.com</bdt>. If we ever
          ...
          >
              ...
              >
                ...
                <strong>
                  ...
                  <span style={{ color: "rgb(0, 58, 250)" }}>
                    ...
                    >
                      <a
                        href="http://www.pokestratbuilder.com/privacy-policy"
                        target="_blank"
                        data-custom-class="link"
                      >
                        http://www.pokestratbuilder.com/privacy-policy
                      </a>
                    </bdt>
                  </span>
                </strong>
            ...
            >
              ...
              <span style={{ fontSize: 15 }}>
                ...
                Association (<bdt className="block-component" />
                "AAA"
                ...
                <bdt className="statement-end-if-in-editor" />
                <bdt className="block-component" />
                <bdt className="question">Texas</bdt>
            ...
            >
              <span style={{ fontSize: 15 }}>
                <span style={{ color: "rgb(89, 89, 89)" }}>
                  <bdt className="question">
                    <strong>DaWinnaProductions</strong>
                  </bdt>
                  <strong>
                    <bdt className="block-component" />
                  </strong>
              ...
              <strong>
                ...
                >
                  <strong>
                    <bdt className="question">
                      <bdt className="block-component" />
                      <bdt className="question">n.h.ejim@gmail.com</bdt>
                      <bdt className="statement-end-if-in-editor" />
                    </bdt>
                  </strong>
                </span>
